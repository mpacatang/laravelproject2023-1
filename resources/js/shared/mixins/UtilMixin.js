...
import { getCurrencyPosition, getCurrencySymbol, getDigitAfterDecimal, getTimeFormat } from "@js/services/state/state_helper";
...
export default {
    data() {
        ...
        addExternalJS(src, callback = null) {
            let s, r;
            r = false;
        ...
        getFormattedTimeFromTime(time, params) {
            params = {
                ...{
        ...
        getFormattedDateTime(date, formatter) {
            if (date == null)
                return "-";
        ...
        getFormattedCurrency(amount, option) {
