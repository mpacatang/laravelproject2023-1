...
export default defineComponent({
    ...
    methods: {
        generateData(data: IDeliveryBoyPayout[]) {
            ...
            data?.forEach((payout) => {
                list.push({
                    ...
                    "Pay to delivery": payout.take_from_admin,
                    "Take from delivery": payout.pay_to_admin,
        ...
        async getPayouts(forced = false) {
            ...
            try {
                const response = await Request.getAuth<IData<IDeliveryBoyPayout[]>>(adminAPI.delivery_boy_payouts.get, {forced: forced});
